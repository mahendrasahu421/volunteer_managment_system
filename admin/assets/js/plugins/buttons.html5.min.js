(function (j) {
  "function" === typeof define && define.amd
    ...
    ? (module.exports = function (f, k, v, r) {
        f || (f = window);
        if (!k || !k.fn.dataTable) k = require("datatables.net")(f, k).$;
        k.fn.dataTable.Buttons || require("datatables.net-buttons")(f, k);
        return j(k, f, f.document, v, r);
      })
  ...
  function A(a, b) {
    s === o &&
      (s =
        -1 ===
        z
          .serializeToString(j.parseXML(B["xl/worksheets/sheet1.xml"]))
          .indexOf("xmlns:r"));
      ...
      if (j.isPlainObject(c)) {
        ...
        if (s) {
          ...
          for (g = e.attributes.length - 1; 0 <= g; g--) {
            ...
            -1 !== w.indexOf(":") &&
              (i.push({ name: w, value: f }), e.removeAttribute(w));
          }
          g = 0;
          for (w = i.length; g < w; g++)
            (f = c.createAttribute(
              i[g].name.replace(":", "_dt_b_namespace_token_")
            )),
              (f.value = i[g].value),
  ...
  function n(a, b, d) {
    ...
    d &&
      (d.attr && j(c).attr(d.attr),
      d.children &&
        j.each(d.children, function (a, b) {
          c.appendChild(b);
        }),
      null !== d.text &&
        d.text !== o &&
      ...
      F = function (a, b, d) {
        ...
        if (M)
          ...
          j.onloadend = function () {
            var a = C
              ? j.result
              : j.result.replace(/^data:[^;]*;/, "data:attachment/file;");
    ...
    I = function (a, b) {
      for (
        var d = H(b),
          ...
          g = b.fieldSeparator,
          j = RegExp(e, "g"),
          i = b.escapeChar !== o ? b.escapeChar : "\\",
          f = function (a) {
            for (var c = "", b = 0, d = a.length; b < d; b++)
              0 < b && (c += g),
                (c += e ? e + ("" + a[b]).replace(j, i + e) + e : a[b]);
            return c;
          },
          h = b.header ? f(c.header) + d : "",
          k = b.footer && c.footer ? d + f(c.footer) : "",
          n = [],
          m = 0,
          l = c.body.length;
        m < l;
        ...
        n.push(f(c.body[m]));
      return { str: h + n.join(d) + k, rows: n.length };
    },
    J = function () {
      if (
        !(
  ...
  q.ext.buttons.excelHtml5 = {
    ...
    action: function (a, b, d, c) {
          ...
          for (var b = 0, d = a.length; b < d; b++) {
            ...
            f ||
              ...
              (a[b].match &&
                ...
                ? (f = n(i, "c", {
                    attr: { t: "n", r: e },
                    children: [n(i, "v", { text: a[b] })],
                  }))
                : ((h = !h.replace
                    ? h
                    : h.replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "")),
                  (f = n(i, "c", {
                    attr: { t: "inlineStr", r: e },
                    children: {
                      row: n(i, "is", {
                        children: {
                          row: n(i, "t", {
      ...
      var p = function (a, c) {
          ...
          b[0].appendChild(
            n(i, "mergeCell", { attr: { ref: "A" + a + ":" + x(c) + a } })
          );
      ...
      d = g;
      h = 0;
      for (var s = k.body.length; h < s; h++) m(k.body[h], g);
      h = g;
      c.footer &&
        k.footer &&
        (m(k.footer, g), j("row:last c", i).attr("s", "2"));
      ...
      for (s = k.header.length; p < s; p++)
        m.appendChild(
          n(i, "col", {
            attr: { min: p + 1, max: p + 1, width: L(k, p), customWidth: 1 },
          })
        );
      m = a.xl["workbook.xml"];
      j("sheets sheet", m).attr("name", G(c));
      c.autoFilter &&
        (j("mergeCells", i).before(
          n(i, "autoFilter", {
            attr: { ref: "A" + d + ":" + x(k.header.length - 1) + h },
          })
        ),
        j("definedNames", m).append(
          n(m, "definedName", {
            attr: {
  ...
  q.ext.buttons.pdfHtml5 = {
    ...
    action: function (a, b, d, c) {
      ...
      d = {
        ...
        content: [{ table: { headerRows: 1, body: e }, layout: "noBorders" }],
        styles: {
          tableHeader: {
            bold: !0,
            fontSize: 11,
