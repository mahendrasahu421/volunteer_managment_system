					...
					<div class="card-body">
						...
						<form role="form" method="post">
							<div class="input-group mb-2">
								<input type="password" required class="form-control" placeholder="Current Password"
									id="oldpassword" name='oldpassword' value="<?php echo set_value('oldpassword'); ?>">
							...
							<div class="input-group mb-2">
								<input type="password" required class="form-control" placeholder="New Password"
									id="newpassword" name='newpassword' value="<?php echo set_value('newpassword'); ?>">
								<?php echo form_error('newpassword', '<div class="error">', '</div>'); ?>
							</div>
							<div class="input-group mb-4">
								<input type="password" required class="form-control" placeholder="Re-Type New Password"
									id="confirmnewpassword" name='confirmnewpassword'
									value="<?php echo set_value('confirmnewpassword'); ?>">
								<?php echo form_error('confirmnewpassword', '<div class="error">', '</div>'); ?>
							</div>
							<button class="btn btn-block btn-primary mb-1 rounded-pill" id="submit">Change
								Password</button>
