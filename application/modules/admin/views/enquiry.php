                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($volunteerData['status'] >= 2) { ?>
                                                            <button type='button' onclick="getId_sendmail('<?php echo $volunteerEmail; ?>',<?php echo $volunteer_id; ?>)" class='badge bg-warning  me-1 mb-1 mt-1'>Already Mail
                                                                Sent(<?php echo $volunteerData['mail_count']; ?>)</button>
                                                        <?php }
                                                        if ($volunteerData['status'] == 1) { ?>
                                                            <button type='button' onclick="getId_sendmail('<?php echo $volunteerEmail; ?>',<?php echo $volunteer_id; ?>)" class='badge bg-info  me-1 mb-1 mt-1'>Send
...
<script>
    function getId_sendmail(volunteerEmail, volunteer_id) {
        var volunteer_sendId = volunteerEmail;
        var volId = volunteer_id;
