                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <div class="text-center" id="confirm_short"><button type="button" class="btn btn-primary fs-14 shortlist_email" data-bs-dismiss="modal">Yes</button>
                            </div>
                                            ...
                                            <div class="process-row nav nav-tabs">
                                                ...
                                                <?php } else { ?>
                                                    <div class="process-step" style="width: 20%;">
                                                        ...
                                                        <p>
                                                            ...
                                                            ?>
                                                            <br>
                                                            <input type="radio" class="demo4 me-1" name="short_radio" <?php echo ($interuser['status'] == 2 ? "checked=checked" : '');  ?> <?php echo ($interuser['status'] == 0 ? "disabled" : '');  ?> value="Shortlisted">Shortlisted
                                                            <input type="radio" class="demo4 me-1" name="short_radio" <?php echo ($interuser['status'] == 0 ? "checked=checked" : '');  ?> <?php echo ($interuser['status'] == 2 ? "disabled" : '');  ?> value="Not Shortlisted">Not Shortlisted
                                                        </p>
                                                        <button class="btn btn-info shortlist_email" <?php echo ($interuser['status'] > 1 ? ($interuser['status'] > 1 ? 'disabled' : '') : '');
                                                                                                        echo $disabl; ?> title="Email"><i class="fa fa-paper-plane" aria-hidden="true"></i></button>
                                                    </div>
                                                <?php } ?>
                                                <!-- ############   End Shortlisted div     ################## -->
                                                ...
                                                <?php if ($interuser['status'] == 5) {  ?>
                                                    <div class="process-step" style="width: 20%;">
                                                        ...
                                                        <button class="btn btn-info mb-5 mt-5" data-toggle="modal" data-target="#exampleModaleditor">send offer</button>
                                                ...
                                                <?php if ($interuser['status'] == 7) { ?>
                                                    <div class="process-step">
                                                        ...
                                                        <input type="radio" name="Join_radio" <?php if ($process_step[0] == 8) {
                                                                                                    echo ($process_step[1] == 1 ? "checked" : "");
                                                                                                }  ?> value="Join">Join
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="update_offer_latter" method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <label class="form-label"> Interns
                                                                        Type</label>
                                                                    <select class="form-select" id="internshipType" name="internshipType" id="validationCustom04" required>
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <select class="form-select" name="durations" id="internship_durations" required>
                                                                        ...
                                                                        <?php for ($i = 4; $i <= 12; $i++) { ?>
                                                                            <option value="<?php echo $i; ?>" <?php echo $i == $interuser['internshipDeruation'] ? 'selected' : ''; ?>>
                                                                                <?php echo $i . " Weeks"; ?>
                                                                            </option>
                                                                        <?php } ?>
                                                                    </select>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="button" id="update_offer_letter" class="btn btn-primary">Save &
                                                                    Next</button>
                                            ...
                                            <div class="modal-dialog modal-xl" role="document" style="width:690px;">
                                                <form action="offer_lattersend_orientation_emails" method="">
                                                    ...
                                                    <div class="modal-content ">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" id="saveOfferLatter" class="btn btn-secondary" data-dismiss="modal">Save
                                                            </button>
                                                            ...
                                                            <button type="button" class="btn btn-warning interview_final_mail">
                                                                <a href="<?php echo base_url() ?>send_offerLetter_emails/<?php echo $encoded_id; ?>">Send
                                                                </a>
                                                            </button>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <tbody id="tdd">
                                                                    <?php if (empty($user_schedule)) {  ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <input type="text" data-role="date" style="color:#000" name="schedule_date" class="form-control dob_cafc_interview schedule_date mydate" value="" placeholder="MM/DD/YYYY" id="newid">

                                                                            </td>
                                                                            <td>
                                                                                <div class="input-group clockpicker" data-autoclose="true" style="color:#000;">
                                                                                    <input type="time" class="form-control schedule_time" placeholder="09:30" name="schedule_time" value="<?php echo date('h:i A', time()); ?>">
                                                                            ...
                                                                            <td>
                                                                                <textarea name="hr_description" class="form-control hr_description" placeholder="Decription"> </textarea>
                                                                            </td>
                                                                            <td></td>
                                                                            <td></td>
                                                                            <td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td style="line-height: 32px;">
                                                                                    <select style="color:#000; margin-top: 1%" class="form-control mode" <?php echo ($u_schedule['mode'] != "" ? "disabled" : '') ?>>
                                                                                        <option value="">Select mode</option>
                                                                                        <option value="On Call" <?php echo ($u_schedule['mode'] == "On Call" ? "selected=selected" : '') ?>>
                                                                                            On Call</option>
                                                                                        <option value="Face to Face" <?php echo ($u_schedule['mode'] == "Face to Face" ? "selected=selected" : '') ?>>
                                                                                            Face to Face</option>
                                                                                        <option value="Video Call" <?php echo ($u_schedule['mode'] == "Video Call" ? "selected=selected" : '') ?>>
                                                                                            Video Call</option>
                                                                                    </select>
                                                                                </td>
                                                                                <td>
                                                                                    <input type="text" data-role="date" style="color:#000" name="schedule_date" <?php echo ($u_schedule['schedule_date_time'] != "0000-00-00 00:00:00" ? "disabled" : '') ?> class="form-control dob_cafc_interview schedule_date mydate" value="<?php if ($u_schedule['schedule_date_time'] != "0000-00-00 00:00:00") {
                                                                                                                                                                                                                                                                                                                                        echo date("m/d/Y", strtotime($u_schedule['schedule_date_time']));
                                                                                                                                                                                                                                                                                                                                    } ?>" placeholder="MM/DD/YYYY">
                                                                                    <span style="display:none;color:red" class="erorr">Date must be greater then
                                                                                        previous schedule date</span>
                                                                                    <span style="display:none;color:red" class="schedule_error"></span>
                                                                                </td>
                                                                                <td>
                                                                                    <div class="input-group clockpicker" data-autoclose="true" style="color:#000;">
                                                                                        <input type="time" class="form-control schedule_time" placeholder="09:30" name="schedule_time" <?php echo ($u_schedule['schedule_date_time'] != "0000-00-00 00:00:00" ? "disabled" : '') ?> value="<?php if ($u_schedule['schedule_date_time'] != "0000-00-00 00:00:00") {
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <textarea name="hr_description" class="form-control hr_description" placeholder="Decription" <?php echo ($u_schedule['schedule_date_time'] != "0000-00-00 00:00:00" ? "disabled" : '') ?>><?php echo $u_schedule['hr_description'] ?> </textarea>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    ?>
                                                                                        <select style="color:#000;" class="form-control interview_status" name="interview_status" <?php echo $button_disable ?>>
                                                                                            ...
                                                                                            ?>
                                                                                                <option value="<?php echo $step['step_id'] ?>" <?php echo $sel ?>>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <button class="btn btn-info <?php echo ($u_schedule['schedule_date_time'] == '0000-00-00 00:00:00' ? "save_schedule" : "save_btn_action") ?> " title="Save" data-action="" <?php echo $save_mail_button;
                                                                                                                                                                                                                                                                echo ($process_step[0] > 4 ? "disabled" : '') ?>><i class="fa fa-paste"></i> </button>
                                                                                    <?php
                                                                                    ...
                                                                                    ?>
                                                                                    <button class="btn btn-info mail_btn_action" data-action="<?php echo $resudule_data_aciton ?>" title="Email" <?php echo $save_mail_button . ' ' . ($process_step[0] > 4 ? "disabled" : ''); //echo $disabl_mail;  
