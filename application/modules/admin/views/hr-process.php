...
<div class="main-content app-content mt-0">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <div class="text-center confirm" id="confirm_reject"><button type="button"
                                    class="btn btn-primary fs-14 not_shortlist_email"
                                                ...
                                                <?php } else { ?>
                                                    <div class="process-step" style="width: 20%;">
                                                        ...
                                                        <p>
                                                            ...
                                                            ?>
                                                            <br>
                                                            <input type="radio" class="demo4 me-1" name="short_radio" <?php echo ($interuser['status'] == 2 ? "checked=checked" : ''); ?>
                                                                <?php echo ($interuser['status'] == 0 ? "disabled" : ''); ?>
                                                                value="Shortlisted">Shortlisted
                                                            <input type="radio" class="demo4 me-1" name="short_radio" <?php echo ($interuser['status'] == 0 ? "checked=checked" : ''); ?>
                                                ...
                                                <?php if ($interuser['status'] == 5) { ?>
                                                    <div class="process-step" style="width: 20%;">
                                                        ...
                                                        <button class="btn btn-info mb-5 mt-5" data-toggle="modal"
                                                            data-target="#exampleModal">Edit offer</button>
                                                            <button id="send_offer_btn" class="btn btn-info mb-5 mt-5" data-toggle="modal"
    data-target="#exampleModaleditor"
    style="<?php echo ($interuser['joining_date'] == '') ? 'display:none;' : ''; ?>">
    Send Offer
</button>
                                                ...
                                                <?php if ($interuser['status'] == 7) { ?>
                                                    <div class="process-step">
                                                        ...
                                                        ?>
                                                        <button type="button"
                                                            class="btn <?php echo $bnt_color ?> btn-circle" <?php echo $bnt_disable ?>><i class="fa fa-industry fa-3x"></i></button>
                                                        <p>
                                                    ...
                                                    <div class="modal-content ">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="col-md-12">
                                                                <div class="modal-body">
                                                                    <div class="col-md-12">
                                                                        <label class="form-label"> Confirmation
                                                                            letter</label>
                                                                        <input type="hidden"
                                                                        ...
                                                                        <div class="col-md-12 mt-3">
                                                                            <textarea class="content" id="emialcontent"
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <!--<button class="btn btn-info interview_final_mail" title="Email"><i
                                                            class="fa fa-paper-plane" aria-hidden="true"></i></button>-->
                                                            <button id="sendoffermail" type="button" disabled
                                                                class="btn btn-warning interview_final_mail">
                                                                <a
                                                                            ...
                                                                            <td>
                                                                                <div class="input-group clockpicker"
                                                                                    ...
                                                                                    <input type="time"
                                                                                        ...
                                                                                        value="<?php echo date('h:i A', time()); ?>">
                                                                    ...
                                                                    <?php } else {
                                                                        ...
                                                                        foreach ($user_schedule as $u_schedule) { ?>
                                                                            <tr>
                                                                                ...
                                                                                <td style="line-height: 32px;">
                                                                                    <select style="color:#000; margin-top: 1%"
                                                                                        class="form-control mode" <?php echo ($u_schedule['mode'] != "" ? "disabled" : '') ?>>
                                                                                        <option value="">Select mode</option>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <textarea name="hr_description"
                                                                                        class="form-control hr_description"
                                                                                        placeholder="Decription" <?php echo ($u_schedule['schedule_date_time'] != "0000-00-00 00:00:00" ? "disabled" : '') ?>><?php echo $u_schedule['hr_description'] ?> </textarea>
    ...
    <?php if ($u_schedule['schedule_date_time'] != '0000-00-00 00:00:00') {
        ...
        // 🔥 New Condition: If status = 2 → Disable dropdown
        if ($interuser['status'] == 2) {
            $button_disable = "disabled";
        }
        ?>
        <select style="color:#000;" class="form-control interview_status"
            name="interview_status" <?php echo $button_disable; ?>>
            <option value="">Select status</option>
            <?php foreach ($step_name as $step) {
                $sel = ($u_schedule['round_status'] == $step['step_id']) ? "selected=selected" : '';
                ?>
                                                                                ...
                                                                                <td>
                                                                                    <?php if ($u_schedule['schedule_date_time'] != '0000-00-00 00:00:00') { ?>
                                                                                        <textarea name="comment"
                                                                                            class="form-control comment" <?php echo $button_disable ?>><?php echo $u_schedule['comment'] ?></textarea>
                                                                                    <?php } ?>
                                                                                </td>
                                                                                <td>
    ...
    data-action=""
    <?php 
        echo $save_mail_button;
        echo ($process_step[0] > 4 || $interuser['status'] == 5) ? "disabled" : ''; 
    ?>>
    <i class="fa fa-paste"></i>
                                                                                   ...
                                                                                   <button class="btn btn-info mail_btn_action"
                                                                                        ...
                                                                                        <?php
                                                                                            echo $save_mail_button . ' ';
                                                                                            echo ($process_step[0] > 4 || $interuser['status'] == 5 || $interuser['status'] == 3) ? "disabled" : "";
                                                                                        ?>
                                                                                    >
