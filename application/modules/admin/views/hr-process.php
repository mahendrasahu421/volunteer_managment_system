<style>
   ...
   /* Loader Styles - Center mein dikhne ke liye */
#emailLoader {
    position: fixed;
    top: 0;
    left: 0;
                        ...
                        <div class="col-md-12 " style="text-align: left;">
                            <div class="col-md-3" style="padding-left: 1%;">
                                <h4 style=" font-weight: 600;margin-top: 20px;">
                                    <?php echo $interuser['first_name'] . " " . $interuser['last_name'] ?>
                                </h4>
                            </div>
                            <div class="col-md-9">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <div class="text-center" id="confirm_short"><button type="button" class="btn btn-primary fs-14 shortlist_email" data-bs-dismiss="modal">Yes</button></div>
            ...
            <div id="myModal1" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <div class="text-center confirm" id="confirm_reject"><button type="button" class="btn btn-primary fs-14 not_shortlist_email" data-bs-dismiss="modal">Yes</button></div>
                            <div class="text-center cancel_short"><button type="button" class="btn btn-default fs-14" data-bs-dismiss="modal">NO</button></div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="process">
                                            <div class="process-row nav nav-tabs">
                                                <div class="process-step" style="width: 20%;">
                                                    ...
                                                    <p><small><strong>Submission</strong></small><br> <small>Date: <?php echo $interuser['creation_date']; ?></small></p>
                                                </div>
                                                ...
                                                <?php if ($interuser['status'] == 3 || $interuser['status'] == 5 || $interuser['status'] == 6 || $interuser['status'] == 7 || $interuser['status'] == 8) { ?>
                                                    <div class="process-step" style="width: 20%;">
                                                        ...
                                                        <p><small><strong>Shortlist</strong></small></p>
                                                ...
                                                <?php } else { ?>
                                                    <div class="process-step" style="width: 20%;">
                                                        <button type="button" class="btn btn-circle process_btn <?php echo $bnt_color ?>"><i class="fa fa-check fa-3x"></i></button>
                                                        <p><small><strong>Shortlist</strong></small>
                                                            <?php $can = $this->Crud_modal->check_numrow("interns", "intern_id='$intern_id'");
                                                            $disabl = '';
                                                            if ($can > 0) { $disabl = 'disabled'; } ?>
                                                            <br>
                                                           <?php if ($interuser['status'] == 0) { ?>
...
<?php } ?>
    ...
    <p><small><strong>Shortlist</strong></small>
        <?php 
        $can = $this->Crud_modal->check_numrow("interns", "intern_id='$intern_id'");
        $disabl = '';
        if ($can > 0) { $disabl = 'disabled'; } 
        ?>
        <br>
        ...
        <?php } ?>
                                                ...
                                                <?php } else { ?>
                                                    <div class="process-step" style="width: 20%;">
                                                        ...
                                                        <p><strong>Interview</strong><br></p>
                                                    </div>
                                                <?php } ?>
                                                ...
                                                <?php if ($interuser['status'] == 5) { ?>
                                                    <div class="process-step" style="width: 20%;">
                                                        ...
                                                        <p><strong>Confirmation letter</strong></p>
                                                        <button class="btn btn-info mb-5 mt-5" data-toggle="modal" data-target="#exampleModal">Edit offer</button>
                                                        <button id="send_offer_btn" class="btn btn-info mb-5 mt-5" data-toggle="modal" data-target="#exampleModaleditor" style="<?php echo ($interuser['joining_date'] == '') ? 'display:none;' : ''; ?>">Send Offer</button>
                                                    </div>
                                                <?php } else { ?>
                                                    <div class="process-step" style="width: 20%;">
                                                        <button type="button" class="btn <?php echo $bnt_color ?> btn-circle process_btn" <?php echo $bnt_disable ?>><i class="fa fa-file-text-o fa-3x"></i></button>
                                                ...
                                                <?php if ($interuser['status'] == 7) { ?>
                                                    <div class="process-step">
                                                        ...
                                                        $bnt_addtion_disable = '';
                                                        if ($process_step[0] < 5) { $bnt_addtion_disable = "disabled"; }
                                                        ?>
                                                        ...
                                                        <input type="radio" name="Join_radio" <?php if ($process_step[0] == 8) { echo ($process_step[1] == 1 ? "checked" : ""); } ?> value="Join">Join
                                                        <input type="hidden" class="form-control Join_date" value="<?php echo $interuser['creation_date']; ?>" name="Join_date" />
                                                        <input type="radio" name="Join_radio" <?php if ($process_step[0] == 8) { echo ($process_step[1] == 1 ? "checked" : ""); } ?> value="Not Join">Not Join
                                                    </div>
                                                <?php } else { ?>
                                                    <div class="process-step">
                                                        <button type="button" class="btn <?php echo $bnt_color ?> btn-circle" <?php echo $bnt_disable ?>><i class="fa fa-industry fa-3x"></i></button>
                                    ...
                                    <div>
                                        <div class="modal" role="dialog" id="exampleModal">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-warning">
                                                        <h5 class="modal-title">Generate Confirmation letter</h5>
                                                        ...
                                                        <form action="update_offer_latter" method="post">
                                                            <div class="modal-body">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <input type="date" class="form-control" value="<?php echo $interuser['modification_date']; ?>" id="offerLatter_update_date" name="offerLatter_update_date" />
                                                                </div>
                                                                <input type="hidden" value="<?php echo $interuser['intern_id']; ?>" id="internship_id" name="intern_id" />
                                                                <div class="col-md-12">
                                                                    <label class="form-label">Interns Type</label>
                                                                    <select class="form-select" id="internshipType" name="internshipType" required>
                                                                        <option value="1" <?php if ($interuser['vol_type_id'] == 1) { echo "selected"; } ?>>Online</option>
                                                                        <option value="2" <?php if ($interuser['vol_type_id'] == 2) { echo "selected"; } ?>>Offline</option>
                                                                        <option value="3" <?php if ($interuser['vol_type_id'] == 3) { echo "selected"; } ?>>Hybrid</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <label class="form-label">Duration</label>
                                                                    <select class="form-select" name="durations" id="internship_durations" required>
                                                                        <?php for ($i = 4; $i <= 12; $i++) { ?>
                                                                            <option value="<?php echo $i; ?>" <?php echo $i == $interuser['internshipDeruation'] ? 'selected' : ''; ?>><?php echo $i . " Weeks"; ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" id="update_offer_letter" class="btn btn-primary">Save & Next</button>
                                                                <button type="button" class="btn btn-secondary" id="saveDa" data-dismiss="modal">Close</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="col-md-12">
                                                                <div class="modal-body">
                                                                    <div class="col-md-12">
                                                                        <label class="form-label">Confirmation letter</label>
                                                                        <input type="hidden" value="<?php echo $interuser['email']; ?>" id="intern_email">
                                                                        <input type="hidden" value="<?php echo $interuser['intern_id']; ?>" id="intern_id">
                                                                        <div class="col-md-12 mt-3">
                                                                            <textarea class="content" id="emialcontent" name="example"><?php echo $final_offerdata; ?></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" id="saveOfferLatter" class="btn btn-secondary" data-dismiss="modal">Save</button>
                                                            <button id="preview" disabled type="button" class="btn btn-warning">
                                                                <a href="<?php echo base_url() ?>view_offer_letter/<?php echo $encoded_id; ?>" target="_blank">Preview</a>
                                                            </button>
                                                            <button id="sendoffermail" type="button" disabled class="btn btn-warning interview_final_mail">
                                                                <a href="<?php echo base_url() ?>send_offerLetter_emails/<?php echo $encoded_id; ?>">Send</a>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </form>
                                        ...
                                        <?php if ($interuser['status'] == 2 || $interuser['status'] == 3 || $interuser['status'] == 5 || $interuser['status'] == 6 || $interuser['status'] == 7 || $interuser['status'] == 8 || $interuser['status'] == 11) { ?>
                                                            ...
                                                            <table id="example" class="display" cellspacing="0" width="100%">
                                                                <thead>
                                                                    ...
                                                                    <tr class="bg-gray-light">
                                                                        ...
                                                                        <th style="color:#000">Time (AM/PM)</th>
                                                                ...
                                                                <tbody id="tdd">
                                                                    <?php if (empty($user_schedule)) { ?>
                                                                        <tr>
                                                                            ...
                                                                            <td><input type="text" data-role="date" style="color:#000" name="schedule_date" class="form-control dob_cafc_interview schedule_date mydate" value="" placeholder="MM/DD/YYYY" id="newid"></td>
                                                                            <td><input type="text" class="form-control schedule_time_ampm" name="schedule_time" placeholder="hh:mm AM/PM"></td>
                                                                            <td><textarea style="color:#000;" name="venue" class="form-control vensue" placeholder="Venue"></textarea></td>
                                                                            <td><textarea name="hr_description" class="form-control hr_description" placeholder="Decription"></textarea></td>
                                                                            <td></td>
                                                                            <td></td>
                                                                            <td>
                                                                    ...
                                                                    <?php } else {
                                                                        ...
                                                                        foreach ($user_schedule as $u_schedule) { ?>
                                                                            <tr>
                                                                                ...
                                                                                <td><input type="text" class="form-control schedule_time_ampm" name="schedule_time" <?php echo ($u_schedule['schedule_date_time'] != "0000-00-00 00:00:00" ? "disabled" : '') ?> value="<?php if ($u_schedule['schedule_date_time'] != "0000-00-00 00:00:00") { echo date("h:i A", strtotime($u_schedule['schedule_date_time'])); } ?>" placeholder="hh:mm AM/PM"></td>
                                                                                <td><textarea style="color:#000;" name="venue" class="form-control venue" placeholder="Venue" disabled><?php if ($u_schedule['venue'] == '') { echo "City: " . $cityi['city_name'] . "State: " . $statei['state_name']; } else { echo $u_schedule['venue']; } ?></textarea></td>
                                                                                <td><textarea name="hr_description" class="form-control hr_description" placeholder="Decription" <?php echo ($u_schedule['schedule_date_time'] != "0000-00-00 00:00:00" ? "disabled" : '') ?>><?php echo $u_schedule['hr_description'] ?></textarea></td>
                                                                                <td>
                                                                                    <?php if ($u_schedule['schedule_date_time'] != '0000-00-00 00:00:00') {
                                                                                        $button_disable = '';
                                                                                        if (sizeof($user_schedule) == ($i - 1)) {
                                                                                            if ($process_step[0] > 4) { $button_disable = "disabled"; }
                                                                                        } else { $button_disable = "disabled"; } ?>
                                                                                        <select style="color:#000;" class="form-control interview_status" name="interview_status" <?php echo $button_disable ?>>
                                                                                            ...
                                                                                            <?php foreach ($step_name as $step) {
                                                                                                $sel = '';
                                                                                                if ($u_schedule['round_status'] == $step['step_id']) { $sel = "selected=selected"; } ?>
                                                                                ...
                                                                                <td>
                                                                                    <?php if ($u_schedule['schedule_date_time'] != '0000-00-00 00:00:00') { ?>
                                                                                        <textarea name="comment" class="form-control comment" <?php echo $button_disable ?>><?php echo $u_schedule['comment'] ?></textarea>
                                                                                    <?php } ?>
                                                                                </td>
                                                                                <td>
                                                                                    <?php $save_mail_button = '';
                                                                                    if (sizeof($user_schedule) == ($i - 1)) {
                                                                                        if ($process_step[0] == 3) { $save_mail_button = ""; }
                                                                                    } else { $save_mail_button = "disabled"; } ?>
                                                                                    <input type="hidden" value="<?php echo $u_schedule['schedule_id'] ?>">
                                                                                    <button class="btn btn-info <?php echo ($u_schedule['schedule_date_time'] == '0000-00-00 00:00:00' ? "save_schedule" : "save_btn_action") ?>" title="Save" data-action="" <?php echo $save_mail_button; echo ($process_step[0] > 4 || $interuser['status'] == 5) ? "disabled" : ''; ?>><i class="fa fa-paste"></i></button>
                                                                                    <?php
                                                                                    $resudule_data_aciton = '';
                                                                                    $disabl_mail = '';
                                                                                    if ($u_schedule['round_status'] == 0 && $u_schedule['comment'] != '') {
                                                                                        $resudule_data_aciton = 'interview_reschedule_mail';
                                                                                    } else { $disabl_mail = 'disabled'; } ?>
                                                                                    <button class="btn btn-info mail_btn_action" data-action="<?php echo $resudule_data_aciton; ?>" title="Email" <?php echo $save_mail_button . ' '; echo ($process_step[0] > 4 || $interuser['status'] == 5 || $interuser['status'] >= 4) ? "disabled" : ""; ?>><i class="fa fa-paper-plane" aria-hidden="true"></i></button>
                                                                                </td>
                                                                            </tr>
                                                                        <?php }
                                                                    } ?>
...
<script>
    // Initialize Flatpickr for all AM/PM time inputs
    $(document).ready(function() {
        flatpickr(".schedule_time_ampm", {
            enableTime: true,
            noCalendar: true,
            dateFormat: "h:i K",
            time_24hr: false,
    ...
    // Loader Functions
   // Loader Functions - Center
function showEmailLoader() {
    $('#emailLoader').css('display', 'flex').hide().fadeIn(200);
}

function hideEmailLoader() {
    $('#emailLoader').fadeOut(200);
}
    // Convert AM/PM time to 24-hour format
    function convertTo24Hour(time12h) {
        if (!time12h) return time12h;
        var parts = time12h.trim().toUpperCase().match(/(\d+):(\d+)\s*(AM|PM)/);
    ...
    $(document).ready(function () {
        $('#update_offer_letter').click(function () {
            ...
            var offerLatter_update_date = $('#offerLatter_update_date').val();
            var internshipType = $('#internshipType').val();
            var internship_durations = $('#internship_durations').val();
            datastr = {
                intern_id: intern_id,
    ...
    $('#saveOfferLatter').click(function () {
        ...
        datastr = { intern_id: intern_id, intern_email: intern_email, emialcontent: emialcontent };
        $.ajax({
            ...
            success: function (response) {
                ...
                document.getElementById("sendoffermail").disabled = false;
            }
        });
    });
    ...
    date(".dob_cafc_interview").datepicker({ minDate: 0 });
    date(document).on('mouseleave', '.ui-datepicker-header', function () { $(".ui-tooltip").css("display", "none"); });
    ...
    date('.schedule_date').change(function () {
        ...
        $.ajax({
            ...
            success: function (datas) {
                date_picker_object.parents('tr').find('.schedule_error').text("Schedule interview" + datas).fadeIn().fadeOut(8000);
            },
    ...
    $(".cancel_short").click(function () {
        $("input[name=short_radio]").each(function () { $(this).removeAttr("checked"); });
    });
    ...
    $(document).on("click", ".save_schedule", function () {
        ...
        var schedule_time_id = parentid.find(".schedule_time_ampm");
        var schedule_time = parentid.find(".schedule_time_ampm").val();
        ...
        var interview_status = parentid.find(".interview_status").val();
        var schedule_id = $(this).prev().val();
        var round = 0;
        var previous_date_value = $(this).parents("tr").prev("tr").find(".schedule_date").val();
        
        if (mode == '') { mode_id.focus(); mode_id.css("border-color", "red"); }
        if (schedule_date == '') { schedule_date_id.css("border-color", "red"); }
        if (schedule_time == '') { schedule_time_id.css("border-color", "red"); }
        if (hr_description == '') { hr_description_id.css("border-color", "red"); }
        
        var attr = venue_id.attr('disabled');
        var venue_cout = 0;
        if (typeof attr === typeof undefined) {
            if (venue == '') { venue_id.css("border-color", "red"); venue_cout = 1; }
        }
        ...
        var con = confirm("Do you want to schedule an interview");
        if (con) {
            if (mode != '' && schedule_date != '' && schedule_time != '' && hr_description != '' && venue_cout == 0) {
                var converted_time = convertTo24Hour(schedule_time);
                $.ajax({
                    method: "post",
                    url: "<?php echo base_url(); ?>save_interview_schedule_data",
                    data: {
                        'mode': mode, 'schedule_date': schedule_date, 'schedule_time': converted_time,
                        'venue': venue, 'hr_description': hr_description, 'round': round + 1,
                        'intern_id': <?php echo $interuser['intern_id'] ?>, 'schedule_id': schedule_id,
                        "interview_status": interview_status,
                    },
                    success: function (datas) { window.location.reload(); },
                    error: function () { alert("Something went wrong"); }
                });
            }
        }
    ...
    $(document).on("change", ".interview_status", function () {
        ...
        var schedule_time_object = $(this).parents("tr").find(".schedule_time_ampm");
        ...
        switch ($(this).val()) {
            case '':
                disable_round_details(mode_object, schedule_date_object, schedule_time_object, venue_object, hr_description_object);
            ...
            case '4':
                ...
                if (mode_object.val() == "Face to Face") { venue_object.removeAttr("disabled"); }
    ...
    function disable_round_details(mode_object, schedule_date_object, schedule_time_object, venue_object, hr_description_object) {
        ...
        switch ($(this).attr("data-action")) {
            ...
            case 'interview_clear':
                if (comment_object.val() != '') {
                    var in_data = { "comment": comment_object.val(), "status": interview_status_object.val(), "schedule_id": schedule_id, 'intern_id': <?php echo $interuser['intern_id'] ?> };
                    var link = '<?php echo base_url(); ?>clear_interview';
                    ajax_function(in_data, link);
                } else { comment_object.focus(); comment_object.css("border-color", "red"); return false; }
                break;
            case 'interview_ongoing':
                if (comment_object.val() != '') {
                    var round = 0;
                    var in_data = { "comment": comment_object.val(), "status": interview_status_object.val(), "schedule_id": schedule_id, 'intern_id': <?php echo $interuser['intern_id'] ?>, 'round': round + 1 };
            ...
            case 'interview_rejected':
                if (comment_object.val() != '') {
                    var in_data = { 'intern_id': <?php echo $interuser['intern_id'] ?>, "comment": comment_object.val(), "status": interview_status_object.val(), "schedule_id": schedule_id };
            ...
            case 'interview_reschedule':
                    ...
                    var venue = parentid.find(".venue").val();
                    var schedule_id = $(this).prev().val();
                    // Use correct round from current row dropdown value
                    var round = parseInt(parentid.find('.interview_status').val() || '4', 10);
                    var previous_date_value = $(this).parents("tr").prev("tr").find(".schedule_date").val();
                    ...
                    if (mode != '' && schedule_date != '' && schedule_time != '' && venue_cout == 0) {
                        var converted_time = convertTo24Hour(schedule_time);
                        // For postponement, we keep the round logic used by backend (send current round index)
                        var in_data = {
                            'mode': mode, 'schedule_date': schedule_date, 'schedule_time': converted_time,
                            'venue': venue, 'round': round, 'intern_id': <?php echo $interuser['intern_id'] ?>,
                            'schedule_id': schedule_id, 'comment': comments
                        };
                        var link = '<?php echo base_url(); ?>update_job_schedule_data';
                        ajax_function(in_data, link);
                    }
                } else { comment_object.focus(); comment_object.css("border-color", "red"); return false; }
                break;
    ...
    // ========== UPDATED MAIL FUNCTIONS WITH LOADER ==========
    
    // Mail Button Action (Interview Schedule Mail)
    $(document).on("click", ".mail_btn_action", function (event) {
        ...
        if (typeof attr !== typeof undefined && attr !== false) {
            ...
            var hr_description = parentid.find(".hr_description").val();
            var interview_status = parentid.find(".interview_status").val();
            var comment = parentid.find(".comment").val();
            var schedule_id = $(this).prev().prev().val();
            // round payload is expected by backend mail templates
            var round = 0;
            ...
            if (con) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        'venue': venue, 'hr_description': hr_description, 'round': round + 1,
                        'intern_id': '<?php echo $interuser['intern_id']; ?>', 'schedule_id': schedule_id,
                        "data_action": data_action, "interview_status": interview_status, "comment": comment
                    },
                    success: function (datas) {
                        hideEmailLoader();
                        if (datas) { alert("Mail sent"); } 
                        else { alert("Something went wrong"); }
                    },
                    error: function () { hideEmailLoader(); alert("Something went wrong"); }
                });
            }
        } else {
    ...
    // Mail Schedule Button (for new schedule row)
    $(document).on("click", ".mail_schedule", function () {
        var parentid = $(this).parents("tr");
        var mode = parentid.find(".mode").val();
        var schedule_date = parentid.find(".schedule_date").val();
        var schedule_time = parentid.find(".schedule_time_ampm").val();
        ...
        if (!mode || !schedule_date || !schedule_time) {
            alert("Please fill all required fields before sending mail");
            return;
        }
        ...
        if (con) {
            ...
            $.ajax({
                ...
                data: {
                    'mode': mode, 'schedule_date': schedule_date, 'schedule_time': converted_time,
                    'venue': venue, 'hr_description': hr_description, 'round': 1,
                    'intern_id': '<?php echo $interuser['intern_id']; ?>', 'schedule_id': '',
                    "data_action": "", "interview_status": "", "comment": ""
                },
                success: function (datas) {
                    hideEmailLoader();
                    if (datas) { alert("Mail sent"); } 
    ...
    $(".shortlist_email").click(function () {
        if ($("input[name=short_radio][value='Shortlisted']").prop("checked")) {
            ...
            $.post("<?php echo base_url(); ?>shortlist_mail", {
                ...
                hideEmailLoader();
                if (data == false) { alert("Something went wrong"); } 
                else { alert("Mail sent"); window.location.reload(); }
            }).fail(function (data) { hideEmailLoader(); alert("Something went wrong"); });
        } else { alert('Please shortlist the candidate.'); }
    });
    ...
    // Send Offer Letter via sendoffermail button
    $(document).on("click", "#sendoffermail", function (e) {
        e.preventDefault();
    ...
    // Interview Final Mail
    $(".interview_final_mail").click(function (e) {
        if ($(this).attr('id') === 'sendoffermail') { return; }
        showEmailLoader();
        $.post("<?php echo base_url(); ?>interview_final_mail", {
            ...
            hideEmailLoader();
            if (data == false) { alert("Something went wrong"); } 
            else { alert("Do you want to take the candidate to the next stage?"); }
        }).fail(function (data) { hideEmailLoader(); alert("Something went wrong"); });
    });

    // Send Offer Letter with PDF
            ...
            if ($("input[type=file]")[0].files[0].type == "application/pdf") {
                ...
                if (con) {
                    ...
                    $.ajax({
                        ...
                        success: function (datas) {
                            hideEmailLoader();
                            if (datas) { alert("Mail sent"); window.location.reload(); } 
                            else { alert("Something went wrong"); }
                        },
                        error: function () { hideEmailLoader(); alert("Something went wrong"); }
                    });
                }
            } else { alert("Please select only pdf"); }
    ...
    $("input:radio[name=Join_radio]").change(function () {
        if ($(this).val() == "Join") {
            if (confirm("Confirm Join")) { join_function("join"); } 
            else { $(this).removeAttr("checked"); }
        } else if ($(this).val() == "Not Join") {
            if (confirm("Confirm not join")) { join_function("not join"); } 
            else { $(this).removeAttr("checked"); }
        }
    });
    ...
    function join_function(join) {
        $.ajax({
            ...
            data: { "join": join, 'intern_id': <?php echo $interuser['intern_id'] ?> },
            success: function (datas) {
                if (datas) { window.location.reload(); } 
                else { alert("Something went wrong"); }
            },
    ...
    // Shortlist Radio Change
    $("input:radio[name=short_radio]").change(function () {
        if ($(this).val() == "Shortlisted") { $('#myModal').modal('show'); } 
        else if ($(this).val() == "Not Shortlisted") { $('#myModal1').modal('show'); }
    });

    $(document).keyup(function (e) { if (e.keyCode === 27) $('.close').click(); });

    $(".mydate").datepicker({ format: 'yyyy-mm-dd', autoclose: true, minDate: 0 });
</script>