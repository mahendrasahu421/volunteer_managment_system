                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="">
                                        <div class="process">
                                            <div class="process-row nav nav-tabs">
                                                ...
                                                ?>
                                                <?php if( $interuser['status']==5|| $interuser['status']==6 || $interuser['status']==7 || $interuser['status']==8  ){ ?>
                                                <div class="process-step" style="width: 20%;">
                                                    <button type="button"
                                                        ...
                                                        if($intern_status==2 || $interuser['status']==5 || $interuser['status']==6 || $interuser['status']==7 || $interuser['status']==8){?>
                                    ...
                                    <div>
                                        ...
                                        <?php  if($interuser['status']==2 || $interuser['status']==5|| $interuser['status']==6 || $interuser['status']==7 || $interuser['status']==8){  ?>
