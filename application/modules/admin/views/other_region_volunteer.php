    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <div>
                    <h1 class="page-title">Volunteer Transfer </h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="admin-dashboard">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page"> Volunteer Transfer </li>
                    </ol>
                </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type='button'
                                                        onclick="getId_sendmail('<?php echo $volunteerEmail; ?>',<?php echo $relocateState; ?>,<?php echo $volunteer_city; ?>,<?php echo $relocate_id; ?>,<?php echo $volunteer_id; ?>)"
                                                        class='badge bg-warning  me-1 mb-1 mt-1'>Accepted</button>
                                                    <?php } else { ?>
                                                    <button type='button'
                                                        onclick="getId_sendmail('<?php echo $volunteerEmail; ?>',<?php echo $relocateState; ?>,<?php echo $volunteer_city; ?>,<?php echo $relocate_id; ?>,<?php echo $volunteer_id; ?>)"
                                                        class='badge bg-info  me-1 mb-1 mt-1'>Accept</button>
...
<script>
function getId_sendmail(volunteerEmail, relocateState, volunteer_city, relocate_id, volunteer_id) {
    var volunteer_sendId = volunteerEmail;
    var relocateState = relocateState;
    var volunteer_city = volunteer_city;
    var relocate_id = relocate_id;
    var volunteer_id = volunteer_id;
    //alert(volunteer_city);
    datastr = {
        volunteer_sendId: volunteer_sendId,
    ...
    $.ajax({
        ...
        success: function(response) {
            $('#success_msg').html('State Update Suuccessfully..');
