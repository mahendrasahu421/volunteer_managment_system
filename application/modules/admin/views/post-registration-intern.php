									...
									<div class="card-body">
										<div id="wizard1">
											...
											<div>
												...
												<div class="row">
													<div class="control-group form-group col-md-6 mb-0">
														<label class="form-label fw-bold">Who was the CRY representative you interacted with?
															*</label>
														<input type="text" name="first_name" class="form-control" placeholder="Designation if working" required>
													</div>
													<div class="control-group form-group col-md-6 mb-0">
														<label class="form-label fw-bold">Which CRY office you had communicated with/ written to?
														</label>
														<select class="form-control select2 form-select" name="gender" data-placeholder="Select Languages">
															<option label="CRY office"></option>
												...
												<div class="row">
													<div class="control-group form-group col-md-6 mb-0">
														<label class="form-label fw-bold">Start date of internship
															*</label>
														<input type="date" name="first_name" class="form-control" placeholder="Designation if working" required>
													</div>
													<div class="control-group form-group col-md-6 mb-0">
														<label class="form-label fw-bold">Profile of project you will be involved in
															*</label>
