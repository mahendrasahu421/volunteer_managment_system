    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="row row-sm">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="pre-registration-volunteer-report" method="post">
                                    ...
                                    <table id="example" class="display" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <!-- <td>
                                                        <?php if ($volunteerData['status'] == 1) { ?>
                                                            <button type='button' class='badge bg-success  me-1 mb-1 mt-1'>Onboard</button>
                                                        <?php } else { ?>
                                                            <button type='button' class='badge bg-info  me-1 mb-1 mt-1'>Pending</button>
