	...
	<div class="side-app">
		...
		<div class="main-container container-fluid">
			...
			<div class="row row-sm">
				<div class="col-lg-12">
					<div class="card">
						<form action="<?php echo base_url('') ?>ragistration-volunteer" method="post">
						...
						<form method="post" action="<?php echo base_url() ?>send_orientation_emails" id="id-form">
												...
												<tr>
													...
													<td>
														<?php if ($volunteerData['status'] == 2) { ?>
															<button type='button' onclick="getId_sendmail('<?php echo $volunteer_id; ?>')" class='badge bg-warning  me-1 mb-1 mt-1'>Send Post registration link(<?php echo $volunteerData['mail_count']; ?>)</button>
														<?php } if($volunteerData['status'] == 3) { ?>
															<button type='button' onclick="getId_sendmail('<?php echo $volunteer_id; ?>')" class='badge bg-info  me-1 mb-1 mt-1'>Post registration link Sent(<?php echo $volunteerData['mail_count']; ?>)</button>
