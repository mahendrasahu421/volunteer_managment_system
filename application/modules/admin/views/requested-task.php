	...
	<div class="side-app">
		<div class="main-container container-fluid">
			<div class="page-header">
				<div>
					<h1 class="page-title">Request For Task ( Volunteers )</h1>
					<ol class="breadcrumb">
						...
						<form action="#" method="post">
							<div class="card-header">
								...
								<select class="form-control select2-show-search form-select" name="task_id">
										...
										?>
											<option value="<?php echo $value['task_id']; ?>" <?php echo $taskId == $value['task_id'] ? 'selected' : ''; ?> ><?php echo ucwords($value['task_title']); ?></option>
										<?php
										}
										?>
											...
											<tr>
												...
												<?php if ($value['rstatus'] == 0) {	?>
													<td>
														...
														<div class="dropdown-menu">
															<a class="dropdown-item" href="<?php echo base_url(); ?>admin-task-accept/<?php echo $encode_userID; ?>/<?php echo $encode_taskID; ?>">Accept</a>
															<a href="<?php echo base_url(); ?>admin-task-reject/<?php echo $encode_userID; ?>/<?php echo $encode_taskID; ?>" class="dropdown-item">Reject</a>
														</div>
													</td>
												<?php } else if ($value['rstatus'] == 1) { ?>
													<td>
														<a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
														<div class="dropdown-menu">
															<a href="#" class="dropdown-item">Task Accepted</a>
														</div>
													</td>
												<?php } else if ($value['rstatus'] == 2) { ?>
													<td>
														<a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
														<div class="dropdown-menu">
															<a href="#" class="dropdown-item">Task Rejected</a>
														</div>
													</td>
												<?php } ?>
											</tr>
