    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <div>
                    <h1 class="page-title">Shortlisted Intern</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="admin-dashboard">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Shortlisted Intern</li>
                    </ol>
                </div>
            ...
            <div class="row row-sm">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="shortlisted-intern" method="post">
...
$('#partnercsv').click(function() {
    //alert();
    $.ajax({
        url: '<?php echo base_url();?>partner-csv',
        type: 'POST',
        data: {
            role_id: '1'
        },
