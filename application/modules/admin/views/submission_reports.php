	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header bg-warning">
				<h4 class="modal-title text-uppercase fw-bold">Submission Report Reject</h4>
	...
	<div class="side-app">
		...
		<div class="main-container container-fluid">
			...
			<div class="page-header">
				<div>
					<h1 class="page-title">Submission Reports</h1>
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="admin-dashboard">Home</a></li>
						<li class="breadcrumb-item active" aria-current="page">Submission Reports</li>
					</ol>
				</div>
			...
			<div class="row row-sm">
				<div class="col-lg-12">
					<div class="card">
						<form action="submission_reports" method="post" id="form">
							...
							<div class="table-responsive ">
								<table id="example" class="display" cellspacing="0" width="100%">
									...
									<tbody>
										<?php
										$count = 1;
										foreach ($submissionReports as $submissionReportsData) {
											$intern_id = $submissionReportsData['intern_id'];
											$sr_id = $submissionReportsData['sr_id'];
											$volunteerEmail = $submissionReportsData['email'];
										...
										?>
											<tr>
												...
												<td>
													<?php echo date("d-m-Y", strtotime($submissionReportsData['final_sunmission_date'])); ?>
												</td>
												<td>
													<?php echo ucwords($submissionReportsData['first_name'] . ' ' . $submissionReportsData['last_name']); ?>
													<br>
												...
												<td><?php echo $submissionReportsData['mobile']; ?>
												</td>
												<td><?php echo $submissionReportsData['state_name']; ?></td>
												<td><?php echo $submissionReportsData['city_name']; ?></td>
...
<script>
	$("#disaproved").click(function(ev) {
		...
		$.ajax({
			url: '<?php echo base_url() ?>submission-reportReject',
			type: 'post',
			data: datastr,
...
<script>
	function fetch_report(id, userid, display_id) {
		...
		var request = $.ajax({
			url: '<?php echo base_url("submission_report"); ?>',
			method: "POST",
			data: {
				sr_id: id,
				intern_id: userid,
