...
<div class="card">
	<div class="card-body">
	<button class="btn btn-warning">Reference 1</button>
	</div>
	<ul class="list-group list-group-full">
...
<div class="card">
	<div class="card-body">
	<button class="btn btn-warning">Reference 2</button>
	</div>
	<ul class="list-group list-group-full">
		...
		<div class="card-body  card2 pt-3">
			<div class="row">
				...
				<div class="col-lg-6 col-md-9 text-right f-16 font-weight-bold text-uppercase profile-social">
					...
					<li><a href="#" class="icoGoogle" title="Linkedin"><i class="fa fa-linkedin"></i></a></li>
					</ul>
				</div>
			</div>
		</div>
		<div class="card-body">
			<div class="row">
				...
				<div class="col-md-4 m-b-20 text-center">
					...
					?> 
					<!--<img src="<?php echo base_url('user_profile/');?>crop.jpg" class="img-fluid border p-1" alt="" title="" id="profileImage">-->
