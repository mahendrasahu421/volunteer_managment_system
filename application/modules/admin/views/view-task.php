...
<div class="main-content app-content mt-0">
    <div class="side-app">
        <div class="main-container container-fluid">
            ...
            <!-- <input type="text" value="<?php echo $taskData['task_id']; ?>"> -->
            <div class="row">
                            ...
                            <div class="m-t-20 no-block">
                                <div class="row f-16">
                                    ...
                                    <div class="col-lg-10 col-md-9 col-sm-12">
                                        <p><?php echo $taskData['task_title']; ?></p>
                                    </div>
                                    ...
                                    <div class="col-lg-10 col-md-9 col-sm-12">
                                        <p> <?php echo $taskData['task_brief']; ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex f-16">
                                    <div class="col-lg-6 p-0 row col-md-12">
                                        ...
                                        <div class="col-lg-8 col-md-4 col-sm-12 p-l-20 ">
                                            <?php $publishdate = $taskData['creation_date']; ?>
                                        ...
                                        <div class="col-lg-8 col-md-4 col-sm-12 p-l-20 ">
                                            <?php $startDate = $taskData['start_date']; ?>
                                        ...
                                        <div class="col-lg-8 col-md-4 col-sm-12 p-l-20">
                                            <?php $endDate = $taskData['expected_end_date']; ?>
                                            <?php if ($endDate == NULL) {
                                                echo 'NA';
                                            } else { ?>
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-12 p-l-20">
                                            <ul class="members-list">
                                                <li><?php echo $taskData['volunteer_required']; ?></li>
                                            </ul>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
