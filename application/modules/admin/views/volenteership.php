	...
	<div class="side-app">
		...
		<div class="main-container container-fluid">
				...
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						<div class="card-body">
							...
							<div class="col-md-12 mt-3"><textarea class="content" id="emialcontent" name="example"><?php echo $emailData['body_content'] ?></textarea></div>
							<div class="modal-footer">
			...
			<div class="row row-sm">
				<div class="col-lg-12">
					<div class="card">
						<form action="<?php echo base_url() ?>volenteership" method="post">
								...
								<div class="col-md-3">
									<select class="form-control select2-show-search form-select" name="state_name" id="state_name">
										...
										<?php foreach ($states as $sd) { ?>
											<option value="<?php echo $sd['state_id']; ?>" <?php echo $state == $sd['state_id'] ?
																								"selected" : "";
																							?>>
						...
						<form method="post" action="send_orientation_emails" id="id-form">
							...
							<div class="card-body">
								<div class="table-responsive ">
												...
												<tr>
													...
													<td>
														<?php if ($volunteerData['status'] == 5) { ?>
															<button type='button' onclick="getId_sendmail('<?php echo $volunteer_id; ?>')" class='badge bg-warning  me-1 mb-1 mt-1'>Already Send Login Credentional(<?php echo $volunteerData['mail_count']; ?>)</button>
														<?php }
														if ($volunteerData['status'] == 4) { ?>
															<button type='button' onclick="getId_sendmail('<?php echo $volunteer_id; ?>')" class='badge bg-info  me-1 mb-1 mt-1'>Send Login Credentional(<?php echo $volunteerData['mail_count']; ?>)</button>
									...
									<input type="button" id="submit3" value="Send Login Credentional" class="mt-5 btn btn-warning  pull-right" id="map_button" style="padding: 1% 2% 1% 2%;">
