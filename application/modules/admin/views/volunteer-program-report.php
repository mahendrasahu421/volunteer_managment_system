	...
	<div class="side-app">
		...
		<div class="main-container container-fluid">
			...
			<div class="page-header">
				<div>
					<h1 class="page-title">Volunteer Program  Report</h1>
					<ol class="breadcrumb">
			...
			<div class="row row-sm">
				<div class="col-lg-12">
					<div class="card">
					<form action="volunteer-list" method="post">
						...
						<form method="post" action="send_orientation_emails" id="id-form">
							...
							<div class="card-body">
								<div class="table-responsive ">
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td><?php echo $volunteerData['volunteer_programs_name']; ?></td>

													<td>
														<?php if ($volunteerData['status'] == 2) { ?>
															<button type='button' onclick="getId_sendmail('<?php echo $volunteerEmail; ?>')" class='badge bg-warning  me-1 mb-1 mt-1'>Already Mail Sent(<?php echo $volunteerData['mail_count']; ?>)</button>
														<?php } else { ?>
															<button type='button' onclick="getId_sendmail('<?php echo $volunteerEmail; ?>')" class='badge bg-info  me-1 mb-1 mt-1'>Send Mail(<?php echo $volunteerData['mail_count']; ?>)</button>
									...
									<input type="botton" id="submit3" value="Present " class="mt-5 btn btn-warning  pull-right" id="map_button" style="padding: 1% 2% 1% 2%;">
