            ...
            <div class="">
                ...
                <div class="container-login100">
                    <div class="wrap-login100 p-0">
                        <div class="card-body">
                            <form id="updatePasswordForm" class="login100-form validate-form" method="post" action="<?php echo base_url() ?>update_internPassword">
                                <span class="login100-form-title">
                                    Reset Password
                                </span>
                                <input type="hidden" value="<?php echo $intern_data; ?>" name="internId">
