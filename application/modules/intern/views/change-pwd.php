...
<form method="post" action="<?php echo base_url(); ?>account-deactive">
	...
	<label class="custom-control-label" for="customCheck1">Account Deactivate.</label>
	 ...
	 <select class="form-control mb-3 hidden" id="showthis" name="showthis" >
		...
		<option value="1"> I am not available for 3-4 Months.</option>
		<option value="2"> I am not available for 5-6 Months.</option>
		<option value="3"> Going out of Country.</option>
		<option value="4"> Not getting any tasks.</option>
	 </select>
	<button type="submit" class="btn btn-primary pull-right" name="deactive" value="submit" onclick="return confirm('Are you sure, you want to Deactivate Account?')"> Deactivate</button>
</form>
