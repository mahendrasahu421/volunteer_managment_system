...
<div class="tab-pane" id="progress-t-tab2" ng-controller="ExampleController">
		...
		<p><span class="btn btn-warning">References-1</span></p>
		...
		<p><span class="btn btn-warning">References-2</span></p>
...
<div class="tab-pane" id="progress-t-tab3">
	...
	<input type="checkbox" class="custom-control-input policy_status" id="customCheck1" name="policy_status" required value="<?php if($userDetails[0]['policy_status']==1){ echo "checked"; } ?>"/>
	...
	<div class="row justify-content-between btn-page">
		...
		<button type="button" onclick="red('http://localhost/caritas_india/profile');"class="btn btn-info button-next" style="display:none;" id="done_next" disabled="disabled">Done</button>
		</div>
	</div>
</form>
</div>
