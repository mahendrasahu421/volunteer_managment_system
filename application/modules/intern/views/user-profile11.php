...
<div class="card">
<div class="card-body">
<center><span class="pcoded-badge badge badge-success">Reference 1</span></center>
</div>
<ul class="list-group list-group-full">
...
<div class="card">
<div class="card-body">
<center><span class="pcoded-badge badge badge-success">Reference 2</span></center>
</div>
<ul class="list-group list-group-full">
...
<ul>
<li><a href="<?php echo ($userDetails[0]['twitter']);?>" class="icoTwitter" title="Twitter" value="<?php echo ($userDetails[0]['twitter']);?>" target="_blank"><i class="fa fa-twitter"></i> </a></li>
<li><a href="<?php echo ($userDetails[0]['linkedin']);?>" class="icoGoogle" title="Linkedin" value="<?php echo ($userDetails[0]['linkedin']);?>" target="_blank"><i class="fa fa-linkedin"></i></a></li>
</ul>
</div>
</div>
</div>
