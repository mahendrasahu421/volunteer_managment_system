                            ...
                            <div class="m-t-20 no-block">
                                <div class="row f-16">
                                    ...
                                    <div class="col-lg-10 col-md-9 col-sm-12">
                                        <p><?php echo $interntask['task_title']; ?></p>
                                    </div>
                                    ...
                                    <div class="col-lg-10 col-md-9 col-sm-12 mt-3">
                                        <p> <?php echo $interntask['task_description']; ?></p>
                                    </div> -->
                                </div>
                                ...
                                <div class="d-flex f-16">
                                    <div class="col-lg-6 p-0 row col-md-12">
                                        ...
                                        <div class="col-lg-8 col-md-4 col-sm-12 p-l-20 ">
                                            <?php $publishdate= $interntask['creation_date'];?>
                                        ...
                                        <div class="col-lg-8 col-md-4 col-sm-12 p-l-20 mt-3 ">
                                            <?php $startDate= $interntask['start_date'];?>
                                        ...
                                        <div class="col-lg-8 col-md-4 col-sm-12 p-l-20 mt-2">
										<?php $endDate= $interntask['expected_end_date'];?>
										<?php if($endDate==NULL){
										     echo 'NA';} else{ ?>
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-12 p-l-20">
                                            <ul class="members-list">
                                                <li><?php echo $interntask['intern_required']; ?></li>
                                            </ul>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
