            ...
            <div class="">
                ...
                <div class="container-login100">
                    <div class="wrap-login100 p-0">
                        <div class="card-body">
                            <form class="login100-form validate-form" method="post" action="<?php echo base_url()?>change-password">
                                <span class="login100-form-title">
                                    Forgot Password
                                </span>
                                <label class="form-label fw-bold">Enter Password</label>
                                <div class="wrap-input100 validate-input" data-bs-validate="Valid email is required: ex@abc.xyz">
                                    <input class="input100" type="text" name="password" placeholder="Email" required id="email">
                                ...
                                <div class="wrap-input100 validate-input" data-bs-validate="Valid email is required: ex@abc.xyz">
                                    <input class="input100" type="text" name="Cpassword" placeholder="Email" required id="email">
                                    <span class="focus-input100"></span>
                                    <span class="symbol-input100">
                                        <i class="zmdi zmdi-email" aria-hidden="true"></i>
                                    </span>
                                ...
                                <div class="container-login100-form-btn">
                                    <button type="submit" class="login100-form-btn btn-warning">
                                        Reset Password
                                    </button>
                                </div>
