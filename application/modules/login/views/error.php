<html>
    <head>
        <title>Reset Password || Caritas India</title>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="border-style:solid;border-width:thin;border-color:#dadce0;border-radius:8px;padding:40px 20px" class="m_-3835115663774870952mdv2rw" align="center">
                                                        ...
                                                        <tbody>
                                                            <tr style="line-height:normal">
                                                                <td style="padding-right:8px" align="right">
                                                                    <img style="width:20px;height:20px;vertical-align:sub;border-radius:50%" src="https://ci4.googleusercontent.com/proxy/QpsGaULeBaBhhOTpb-uwGsICda8b1ae95rM7JtYlDtcjbrJ_fDlrGcQ9nUwocVilT_dWdlntnRieTr4GY_IFycf2zxXXuPXiHCdY7G5yRw7uJHHhalp2NYvY=s0-d-e1-ft#https://www.gstatic.com/accountalerts/email/anonymous_profile_photo.png" alt="" class="CToWUd" width="20" height="20">
                                                                </td>
                                                                <td>
                                                ...
                                                <?php echo $results;?><div style="padding-top:32px;text-align:center">
                                                <a href="<?php echo $href;?>" 
                                                style="font-family:'Google Sans',Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#8e2c24;border-radius:5px;min-width:90px" 
                                                data-saferedirecturl="<?php echo $href;?>">
                                                <?php echo $btn;?></a>
                                                </div>
                                                </div>
                                            </div>
