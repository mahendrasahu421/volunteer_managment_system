                                            ...
                                            <div class="card">
                                                <form id="documentdetails" name="pForm" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="control-group form-group col-md-6 mb-0">
                                                            <label class="form-label fw-bold">ID Proof<span style="color:red; font-size:20px;">*</span>
                                                                <input type="file" class="form-control" id="id_proof_attach1" name="id_proof_attach1" class="form-control"  accept=".pdf" value="" onchange="return validate();">
                                                        ...
                                                        <div class="control-group form-group col-md-6 mb-0">
                                                            ...
                                                            <input type="file" class="form-control" id="add_proof_attach" name="add_proof" accept=".pdf" class="form-control"  value="" onchange="return validate();">
                                                    ...
                                                    <div class="control-group form-group col-md-6 mb-0">
                                                        ...
                                                        <input type="file" class="form-control" accept=".jpg" id="close_up_photo" name="close_up_photo" class="form-control"  value="" onchange="return validate();">
...
<script>
	$("#step_3_submit").click(function(ev) {
		...
		if (NoOfweeks == "" || youInternship == "" || emergency_contact == "" || occupation == "" || name_of_school == "" || designation == "" || language == "" || representative == "" || communicatedWith == "" || NoOfweeks == "" || Startdate_internship == "" || project_profile == "" || where_know_opportunity == "" || signature == "") {
    ...
    <script>
        $('#step2').click(function(e) {
            ...
            else if(age < 18 && letter_parents_attach == ""){
                alert('Please Upload Parents Consent Letter');
                return false;
            }
    ...
    <script>
        $('#id_proof_attach1').change(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url() . 'upload_id_proof' ?>',
                data: datas,
