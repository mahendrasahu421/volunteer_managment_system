...
<form action="<?php echo base_url()?>verfy-login-otp" method="post">
<div class="input-group mb-3">
<input type="number" class="form-control" placeholder="Enter OTP" name="otp" value="" required>
...
<p class="mb-2 text-muted">Resend OTP? <a href="<?php echo base_url(); ?>otp-login" class="f-w-400">Click Here</a></p>
</div>
</div>
</div>
</div>
