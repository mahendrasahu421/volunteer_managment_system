		...
		<div class="main-container container-fluid">
			<div class="page-header">
				...
				<div class="ms-auto pageheader-btn">
					<a href="transfer-form" class="btn btn-warning btn-icon text-white me-2">
						<span>
						...
						<div class="card-body">
							...
							<div class="table-responsive">
								<table id="example" class="display nowrap" style="width:100%">
									...
									<tbody>
                                    <?php $i=1; foreach($transfer_data as $vt){
        							$relocate_id =$vt['volunteer_relocate_id ']; 
        							$encoded_id=rtrim(strtr(base64_encode($relocate_id), '+/', '-_'), '=');
        							?>
										<tr>
										<td><?php echo $i++; ?></td>
										<td><?php echo $vt['state_name']; ?></td>
										<td><?php echo $vt['relocate_state_name']; ?></td>
										<td><?php echo $vt['city_name']; ?></td>
										<td><?php echo $vt['relocate_resion']; ?></td>
                                        <?php if($vt['status']==1){ ?>
										 <td><span class="badge bg-success">Accept</span></td>
                                         <?php }  else if($vt['status']==2){?> 
