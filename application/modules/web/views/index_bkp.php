...
<head>
	...
	<body data-spy="scroll" data-target=".navbar" data-offset="50">
				...
				<div class="container">
					...
					<nav class="collapse navbar-collapse">
						...
						<ul class="nav navbar-nav pull-right" style="margin-top: 10px;">
							...
							<li class="active1"><a href="#Causes">Causes</a></li>
				...
				<div class="white-bg angular section-padding" style="margin-bottom: 30px;">
					...
					<div class="container">
						<div class="section-head">
							...
							Caritas India is a leading humanitarian aid organization particularly in the sectoral
							areas of community managed disaster risk reduction and natural resource management with
							community mobilization as its overarching strategy.
							</p><!-- /.section-description -->
							<p class="section-description">
							Volunteers with Caritas India are known as <b>Caritas Samaritan</b>. We believe in the power of
							volunteerism. It has believed volunteers are people who work in a joint effort; coexist in
							solidarity, seeking unity, respecting, and valuing differences; dialogue and goodwill.
							Volunteers act as a driving force as animators of process of organisation and mobilisation
							towards social transformation. We welcome you on board on this journey.
							</p>
						</div><!-- /.section-head -->
						...
						<div class="row">
							<div class="section-content">
								<div class="content-box col-md-8 from-bottom delay-600">
									...
									<h3 class="content-title">Become a Caritas Samaritan – 5 Easy Steps!</h3>
									<p>
										<strong>
											1. Register <br>
											2. Complete the registration form <br>
											3. Upload your profile <br>
											4. Receive a verification email <br>
											5. Get ready to receive task <br>
										</strong>
									</p>
			...
			<div class="about-parallax parallax-style">
				<div class="parallax-overlay section-padding">
					<div class="container">
						...
						A Strong Dedicated team of <br><span class="amount" style="color:#e12444;">20,000+</span> volunteers so far
						</p><!-- /.parallax-description -->
						<div class="progress-bar-container">
							<div class="progress">
								<div id="about-progress-1" class="progress-bar progress-bar-warning" style="background-color: #e12444;" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
		...
		<!-- Services Section -->
		<section>
			<div class="services-section section-padding"><!--white-bg angular-->
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-4 col-xs-6 from-bottom delay-200 mb-20">
								<div class="service-box">
									...
									<h3 class="service-title content-title cause-heading">
					...
					<div class="container">
						...
						<div class="row">
							<div id="event_time_countdown1" class="next-event-container">
								...
								<div class="col-xs-6 col-sm-4 col-md-4 from-bottom delay-200">
									<div class="time-circle dash days_dash animated" data-animation="rollIn" data-animation-delay="300">
										<span class="time-number">
											<span class="digit">65</span><span class="digit">0</span>
										</span>
								...
								<div class="col-xs-6 col-sm-4 col-md-4 from-bottom delay-1000">
									<div class="time-circle dash minutes_dash animated" data-animation="rollIn" data-animation-delay="900">
										<span class="time-number">
											<span class="digit">18</span><span class="digit">00</span>
										</span>
										<span class="time-name">Total Volunteering Hours</span>
									</div><!-- /.time-circle -->
								</div><!-- /.col-md-3 -->
								<div class="col-sm-2 col-md-2"></div>
							...
							<p class="event-btn-container">
								<a class="btn custom-btn angle-effect mt-2" href="<?php echo base_url(); ?>signup">Join Us</a>
								<a class="btn custom-btn angle-effect mt-2" href="#" data-toggle="modal" data-target="#myModal">List of Dioceses</a>
							</p>
							  ...
							  <div class="modal-dialog modal-lg">
								...
								<div class="modal-content">
								  <div class="modal-header">
									...
									<h4 class="modal-title" style="text-align: center;"><b>List of Dioceses</b></h4>
								  </div>
								  <div class="modal-body">
									<table id="customers" class="table-responsive">
									  ...
									  <tr>
									    ...
									    <input type="hidden" id="last" value="<?php echo $last; ?>" name="last"/>
										<tr class="" id="load"></tr>
										
									</table>
									<center><button class="btn btn-primary" style="margin-top:2%;" type="button" name="loadmore" id="loadmore" value="">
				<i class="fa fa-refresh"></i> Load More</button></center>
								  </div>
								...
								<div class="col-md-9 from-right delay-200">
									<div class="pricing-table">
										...
										<div class="pricing-item" style="width: 100% !important;padding:10px;">
											...
											<p>
												Volunteering is the commitment of a person’s time and energy for the benefit of society and
												the community i.e. the environment of individuals outside one’s immediate family. It is
												undertaken freely and by choice without any expectation for financial gain.
											</p>
											<p>
												Volunteering is one of the key strategic pillars of caritas India. Caritas India believes in the
												value of volunteering as a powerful expression of a people-centred approach to development
												and an essential component of a free and fair democratic society.
												<a id="s_show_pa" onclick="show_table('s_p','s_show_pa');">Show More</a>
											</p>
											<p id="s_p" style="display:none;">
												Caritas India takes responsibility for ensuring that volunteers within the organisation are
												appropriately involved, valued for their contribution and respected as colleagues. However,
												Caritas India reserves the exclusive right to change, add or eliminate any/any part of the
												policies/guidelines described in this manual at any time, same shall be duly notified to the
												volunteers and expects adherence to the changed policy.
												<a id="s_hide_pa" onclick="hide_table('s_p','s_show_pa');">Show Less</a>
											</p>
...
<section>
	<div class="services-section white-bg angular section-padding">
				...
				<div class="row">
					...
					<div class="col-md-3 from-bottom delay-200">	
						<div class="service-box">
							...
							<p class="service-description">
								<center><h5 style="color: #8e2c24; font-weight: bold;">
					...
					<div class="col-md-3 from-bottom delay-200">	
						<div class="service-box">
							...
							<p class="service-description">
								<center><h5 style="color: #8e2c24; font-weight: bold;">
									Completion of 500 volunteering hours with Caritas India
								</h5></center>
								<style>
									.table1>tbody>tr>td
									{
					...
					<div class="col-md-3 from-bottom delay-200">	
						<div class="service-box">
							...
							<p class="service-description">
								<center><h5 style="color: #8e2c24; font-weight: bold;">
									Completion of 4000 volunteering hours with Caritas India
								</h5></center>
								<table class="table table1">
									<tr>
										<td>-</td>
								...
								<table class="table table1" id="p_table" style="margin-top: -20px; display:none;">
									...
									<tr>
										<td>-</td>
										<td>
											The volunteer would be endorsed as Volunteer Captain
						...
						<div class="col-md-4">
							<div class="contact-form-container">
								...
								<form class="contact-form" id="" action="<?php echo base_url('inquiry'); ?>" method="post">
									...
									<button type="submit" class="btn custom-btn angle-effect">Submit</button>
								</form><!-- /.contact-form -->
								...
								<address> 
									<ul class="contact-address">
										<li class="fa-map-marker">
											Caritas India Headquarter: Caritas India, CBCI Centre, Ashok Place, Opposite to Goledakkhana, New Delhi - 11 00 01, India
										</li>
										<li  class="fa-phone">
			...
			<div class="footer-section">
				<div class="container">
					...
					<div class="copyrights pull-left">
						&copy; <a href="#">Caritas India</a> 2014 - <?php echo date('Y'); ?>, All Rights Reserved, Developed by <a href="https://www.neuralinfo.in/">Neural Info Solutions Pvt. Ltd.</a>
					</div><!-- /.copyrights -->
		...
		<script type="text/javascript">
				...
				function init_gmap() {
					...
					$('#googleMaps').gmap3({
						...
						marker: {
							...
							options: { icon: '<?php echo base_url('web/'); ?>assets/images/mapicon.png' }
						}
					});
				}
			...
			<!-- <script>
			$(document).ready(function(){ alert('dnmd'); });
			function click(id,class1)
			{
				alert(class1);
...
<script>
$(document).ready(function(e) { alert('hi');
$('#loadmore').on('click',function(){
   ...
   //alert(lastID);
	 $.ajax({
			...
			//data:'last='+lastID,
			data:{'last':lastID},
			url: "<?php echo base_url('dioceses-load')?>",
